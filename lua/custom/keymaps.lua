...
vim.keymap.set('n', '<leader>ws', Snacks.picker.lsp_workspace_symbols, { desc = 'LSP [W]orkspace [S]ymbols' })
vim.keymap.set('n', '<leader>ds', Snacks.picker.lsp_symbols, { desc = 'LSP [D]ocument [S]ymbols' })
vim.keymap.set('n', '<leader>sr', Snacks.picker.resume, { desc = '[R]esume' })
vim.keymap.set('n', '<leader>dd', Snacks.picker.diagnostics, { desc = 'Search [D]ocument [D]iagnostics' })
